...
const en: Dict = {
  ...
  "modules.title": "Filter by module",
  "modules.summary": "{0}/{1}",
  "modules.all": "All",
  "modules.none": "None",
  "modules.crossOnly": "Cross-boundary edges only",
  "modules.crossOnly.hint": "Hide intra-module relations",
  "arch.MONOLITH": "Monolith",
  "arch.MODULAR_MONOLITH": "Modular monolith",
  "arch.MSA": "MSA",
  "arch.MONOLITH.title": "Single module",
  "arch.MODULAR_MONOLITH.title": "Multiple modules, shared build/DB",
  "arch.MSA.title": "Separate builds/DBs per service",
  ...
  "help.v.rightClick": "Remove the node from the analysis (orphaned neighbors are removed too) · restore from the toolbar",
  ...
  "legend.section.boundary": "Module boundary",
  "legend.boundary.INTRA": "Within a module",
  "legend.boundary.CROSS_FK": "Cross-module FK (real relation)",
  "legend.boundary.CROSS_SOFT": "Cross-module soft ref (id)",
...
const ko: Dict = {
  ...
  "modules.label": "모듈:",
  "modules.title": "모듈로 필터",
  "modules.summary": "{0}/{1}",
  "modules.all": "전체",
  "modules.none": "해제",
  "modules.crossOnly": "경계 엣지만 보기",
  "modules.crossOnly.hint": "모듈 내부 관계 숨김",
  "arch.MONOLITH": "모놀리식",
  "arch.MODULAR_MONOLITH": "모듈러 모놀리스",
  "arch.MSA": "MSA",
  "arch.MONOLITH.title": "단일 모듈",
  "arch.MODULAR_MONOLITH.title": "여러 모듈, 빌드/DB 공유",
  "arch.MSA.title": "서비스별 빌드/DB 분리",
  ...
  "help.v.rightClick": "그 노드를 분석에서 제거(연관 고립 노드도 함께 제거) · 툴바에서 복원",
  ...
  "legend.section.boundary": "모듈 경계",
  "legend.boundary.INTRA": "모듈 내부",
  "legend.boundary.CROSS_FK": "모듈 간 FK (진짜 관계)",
  "legend.boundary.CROSS_SOFT": "모듈 간 약한참조 (id)",
