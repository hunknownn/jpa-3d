...
const en: Dict = {
  ...
  "help.title": "Usage",
  "help.close": "Close",
  "help.k.clickFocus": "Click (3D)",
  "help.v.clickFocus": "Fly camera to that node · highlight neighbors",
  "help.k.dblClick3d": "Double-click (3D)",
  "help.v.dblClick3d": "Open the entity's source file",
  "help.k.click2d": "Click (2D)",
  "help.v.click2d": "Open the entity's source file",
  "help.k.rightClick": "Right-click",
  "help.v.rightClick": "Re-explore with that node as a center (seed)",
...
const ko: Dict = {
  ...
  "help.title": "사용법",
  "help.close": "닫기",
  "help.k.clickFocus": "클릭 (3D)",
  "help.v.clickFocus": "그 노드로 카메라 이동 · 이웃 강조",
  "help.k.dblClick3d": "더블클릭 (3D)",
  "help.v.dblClick3d": "엔티티의 소스 파일로 이동",
  "help.k.click2d": "클릭 (2D)",
  "help.v.click2d": "엔티티의 소스 파일로 이동",
  "help.k.rightClick": "우클릭",
  "help.v.rightClick": "그 노드를 중심(seed)으로 다시 탐색",
