...
const en: Dict = {
  ...
  "hidden.label": "Hidden:",
  "hidden.title": "Nodes removed from the view",
  "hidden.summary": "{0} hidden",
  "hidden.menuTitle": "Hidden nodes — click to restore",
  ...
  "help.v.rightClick": "Remove the node from the view · restore from the toolbar",
...
const ko: Dict = {
  ...
  "hidden.label": "숨김:",
  "hidden.title": "view 에서 제거한 노드",
  "hidden.summary": "{0}개 숨김",
  "hidden.menuTitle": "숨긴 노드 — 클릭하면 복원",
  "hidden.restore": "복원",
  ...
  "help.v.rightClick": "그 노드를 view 에서 제거 · 툴바에서 복원",
