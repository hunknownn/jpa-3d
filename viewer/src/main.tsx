...
const themeGlobals = window as unknown as { __JPA3D_THEME__?: string; __JPA3D_THEME_BG__?: string };
applyTheme(themeGlobals.__JPA3D_THEME__, themeGlobals.__JPA3D_THEME_BG__);
